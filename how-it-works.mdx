...
description: "[Read the full technical white‑paper ➜](https://aivai.xyz/whitepaper)"
---
...
_Think of MCP as an “open API market” that AIVA agents discover at runtime._ Developers publish **Paths** (deterministic functions) with on‑chain staking. AIVA selects, verifies, and composes these Paths on demand.